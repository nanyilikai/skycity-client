...
public class UnitControler : MonoBehaviour {
    ...
    {
        set { attribute.Ascription = value; }
        get { return attribute.Ascription; }
    }
    ...
    {   //TODO: Get rid of magic numbers.
        ...
        GUI.DrawTexture(new Rect(coordinates.x - HP_BAR_WIDTH / 2, coordinates.y + HP_BAR_HEIGHT / 2, HP_BAR_WIDTH * attribute.HP / attribute.maxHP, HP_BAR_HEIGHT), green);
